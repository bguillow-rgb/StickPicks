...
//
// Usage: node scripts/monitor.mjs --url https://pourpicks.app
...
const SITE = (urlArg || process.env.SITE_URL || 'https://stickpicks.app').replace(/\/$/, '');
const CERT_WARN_DAYS = Number(process.env.CERT_WARN_DAYS || 21);
const MAX_CONCURRENCY = 8;
const UA = 'StickPicks-Monitor/1.0 (+health-check)';
